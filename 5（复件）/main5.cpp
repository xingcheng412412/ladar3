...
std::string path = "/home/sun/5（复件）/tupian/";
// 测试时使用的视频
std::string VIDOE_PATH = "/home/sun/5（复件）/Screenrecorder-2024-02-27-21-01-00-24.mp4";

// 模型
std::string MODEL_PATH = "/home/sun/5（复件）/best_openvino_model/best.xml";
